...
const CACHE_NAME = 'family-tracker-v2.7.0';
const ASSETS = [
    '/familytrack/',
    '/familytrack/index.html',
    '/familytrack/style.css?v=2.7.0',
    '/familytrack/app.js?v=2.7.0',
    '/familytrack/manifest.json?v=2.7.0',
    '/familytrack/icon.png?v=2.7.0'
];
