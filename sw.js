...
const CACHE_NAME = 'family-tracker-v2.4.1';
const ASSETS = [
    '/familytrack/',
    '/familytrack/index.html',
    '/familytrack/style.css?v=2.4.1',
    '/familytrack/app.js?v=2.4.1',
    '/familytrack/manifest.json?v=2.4.1',
    '/familytrack/icon.png?v=2.4.1'
];
