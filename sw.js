...
const CACHE_NAME = 'family-tracker-v2.12.1';
const ASSETS = [
    '/familytrack/',
    '/familytrack/index.html',
    '/familytrack/style.css?v=2.12.1',
    '/familytrack/js/utils.js?v=2.12.1',
    '/familytrack/js/config.js?v=2.12.1',
    '/familytrack/js/geocoding.js?v=2.12.1',
    '/familytrack/js/api.js?v=2.12.1',
    '/familytrack/js/state.js?v=2.12.1',
    '/familytrack/js/ui.js?v=2.12.1',
    '/familytrack/js/map.js?v=2.12.1',
    '/familytrack/js/main.js?v=2.12.1',
    '/familytrack/manifest.json?v=2.12.1',
    '/familytrack/icon.png?v=2.12.1'
];
