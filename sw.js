...
const CACHE_NAME = 'family-tracker-v2.8.2';
const ASSETS = [
    '/familytrack/',
    '/familytrack/index.html',
    '/familytrack/style.css?v=2.8.2',
    '/familytrack/app.js?v=2.8.2',
    '/familytrack/manifest.json?v=2.8.2',
    '/familytrack/icon.png?v=2.8.2'
];
